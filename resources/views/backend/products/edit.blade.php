...
@section('content')
    <div class="content">
        <form method="post" action="{{route('admin.products.update')}}" class="form-horizontal" enctype="multipart/form-data">
            <div class="row">
                <div class="col-md-8">
                    <div class="card ">
                                ...
                                <div class="col-sm-2">
                                    <div class="form-group">
                                        <input type="number" name="saleoff" class="form-control"
                                               value="{{old('saleoff', $product->saleoff)}}" placeholder="VD: 0.1, 0.15,..." step="0.01">
                                    ...
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input" name="show"
                                                   type="checkbox" {{$product->show?'checked':''}}>
                                ...
                                <div class="col-sm-10">
                                    <div class="form-group">
                                        <textarea type="text" name="message"
                                                  class="form-control">{{old('message', $product->message)}}</textarea>
                                        {{--<span class="form-text">A block of help text that breaks onto a new line.</span>--}}
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="col-md-12 m-auto">
                                    ...
                                    <div class="fileinput fileinput-new text-center" data-provides="fileinput">
                                        <div class="fileinput-new thumbnail">
                                            <img src="{{$product->image?asset('images/'.$product->image):asset('backend/img/placeholder.jpg')}}" alt="...">
                                        </div>
